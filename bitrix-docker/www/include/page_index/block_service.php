    ...
    <div class="item-anons">
        <a href="/lazernaya-gravirovka/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Лазерную гравировку можно наносить на сувенирную продукцию из&nbsp;металла, стекла, хрусталя, пластика, дерева, кожи, вспененной резины.</p></span>
            </span>
        </a>
    </div>
    <div class="item-anons">
        <a href="/tisnenie/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Подходит для продукции из натуральной, эко-кожи, дерева, бумаги, картона.</p></span>
            </span>
        </a>
    </div>
</div>
    ...
    <div class="item-anons">
        <a href="/polnocvetnaya-uf-pechat/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Для сувениров из любых материалов: стекло, дерево, пластик, металл, бумага, кожа, ткань</p></span>
            </span>
        </a>
    </div>
    <div class="item-anons">
        <a href="/tampopechat/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Для деликатной сувенирной продукции из кожи, бумаги, пластика, металла, дерева, керамики, стекла</p></span>
            </span>
        </a>
    </div>
</div>
    ...
    <div class="item-anons">
        <a href="/shelkografiya/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Перенос логотипов компании, изображений и надписей алкидными и другими устойчивыми синтетическими красками</p></span>
            </span>
        </a>
    </div>
    <div class="item-anons">
        <a href="/sublimacionnaya_pechat/" class="item" style="background: linear-gradient(99.89deg, #F4F4F4 1.16%, #F6FAFF 101.52%)">
            ...
            <span class="item-top">
                ...
                <span class="item-description"><p>Нанесение высококачественных изображений на различные типы одежды, включая футболки, кепки и рюкзаки. Этот метод печати обладает рядом преимуществ, таких как высокая производительность, автоматизация и возможность изготовления продукции в любых объёмах.</p></span>
            </span>
        </a>
    </div>
</div>