...
$APPLICATION->SetPageProperty("description", "Компания Эклектика предлагает Заявка на разработку сувенирной продукции оптом под нанесение логотипа. ✓ Низкие цены. ✓ Доставка по России. ☎ 8(800) 777-4723");
...
<div itemprop="articleBody">
    ...
    <div class="content" style="padding-bottom: 0px;">
        <p>Сувенирная продукция, изготовленная профессионалами, позволяет успешно решать целый ряд важных задач: выделить сотрудников на ответственном отраслевом мероприятии, отметить заслуги лучших работников, выразить уважение деловым партнерам. При условии качественного производства с учетом актуальных требований стиля она превращается в долгосрочный рекламоноситель, что работает на имидж своего предприятия и формирует дополнительный спрос.</p>
        <h2>Разработка дизайна сувенирной продукции</h2>
        <p>Разработка дизайна сувенирной продукции требует индивидуального и ответственного подхода. Важно учитывать направление деятельности предприятия, ее фирменный стиль, назначение изделий, особенности их практического применения. Чтобы исключить ошибки и предложить клиентам продукцию высокого качества, мы строим сотрудничество в такой последовательности:</p>
        <ul>
            <li>обсуждение будущих изделий и уточнение пожеланий заказчика;</li>
            <li>полный цикл мероприятий по разработке дизайна сувенирной продукции;</li>
            <li>создание макета будущих изделий;</li>
            <li>согласование готового решения с заказчиком, внесение необходимых корректировок;</li>
            <li>запуск образцов в производство.</li>
        </ul>
        <p>Благодаря детальному обсуждению каждого решения заказчик получает сувениры, полностью отвечающие его ожиданиям и условиям практического применения.</p>
        <h2>Виды сувенирной продукции</h2>
        <p>Профессиональная разработка сувенирной продукции позволяет нам предложить клиентам любые виды изделий с оригинальным декором:</p>
        <ul>
            <li>широкий ассортимент посуды для дома и офиса — термокружки, термосы, термостаканы, чайники для заваривания, бутылки и контейнеры, в которых сочетаются внешние и практические преимущества;</li>
            <li>изделия из группы электроники — настольные часы и вентиляторы, наушники, флеш-накопители, увлажнители воздуха, которые сделают работу более продуктивной и комфортной;</li>
            <li>полезные предметы для офиса — часы, органайзеры, настольные лампы, подставки и канцелярские наборы, которые помогут создать удобное рабочее пространство и не отвлекаться от поставленных задач;</li>
            <li>зонты, которые не только защитят от непогоды, но и дополнят образ и станут отличным подарком;</li>
            <li>сумки и рюкзаки, в которых наилучшим образом сочетаются вместительность, эргономичность и внешняя привлекательность;</li>
            <li>десятки полезных товаров для обустройства жилого пространства;</li>
            <li>аксессуары для занятий спортом;</li>
            <li>подарки к праздникам, которые станут приятным сюрпризом для близких, коллег или деловых партнеров, а также помогут надолго сохранить хорошее настроение.</li>
        </ul>
        <p>Каждый вид сувенирной продукции подбирается в индивидуальном порядке с учетом ее назначения и пожеланий заказчика.</p>
        <h2>Преимущества разработки сувенирной продукции в нашей компании</h2>
        <p>Работая на рынке более 20 лет, наша команда готова предложить изготовление сувенирной продукции любого уровня на условиях срочности и соблюдения требований качества:</p>
        <ul>
            <li>низкая себестоимость поможет сэкономить на готовых изделиях;</li>
            <li>детальное обсуждение обеспечит соответствие предложенных решений идеям клиента;</li>
            <li>индивидуальный подход к организации сотрудничества сделает его максимально удобным и выгодным;</li>
            <li>заказы любого объема выполняются в самые сжатые сроки;</li>
            ...
            <form id="dscallme-form" method="POST" enctype="multipart/form-data" novalidate="">
                ...
                <script>
                    ...
                    $(`.content #dscallme .buttonform input`).on(`click`, function () {
                        if ($(`textarea[name="company_name"]`).val() != "" && $(`input[name="name"]`).val() != "" && $(`input[name="email"]`).val() != "") {
                            ym(1087753, `reachGoal`, `otprav_razrabotk`);
                            console.log(`Отправка формы на странице Заявка на разработку сувенирной продукции`);
                        }
                    });

                    $(document).on('submit', '#dscallme-form', function (ev) {
                        ev.preventDefault();
                        var frm = $('#dscallme-form');
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.status === 'success') {
                                    $('#dscallme-form').empty();
                                    $('#dscallme-form').closest('#sendmessage').find('.text-center').empty();
                                    $('#dscallme-form').html('<div class="report-message"><p>Спасибо! Ваша заявка отправлена.</p></div>');
                                } else {
