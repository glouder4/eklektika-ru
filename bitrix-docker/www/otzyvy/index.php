<?
$GLOBALS['OG_TAGS'] = [
    'title' => 'Отзывы о компании Эклектика',
    'description' => 'На данной странице вы можете ознакомиться с отзывами о компании Эклектика.✓ Низкие цены. ✓ Доставка по России. ☎ 8(800) 777-4723',
];
