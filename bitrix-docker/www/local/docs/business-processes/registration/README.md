...
- **2026-05-02:** на стенде подтверждена **успешная E2E регистрация**; именованные webhooks n8n для этой цепочки **отлажены**. Подробности и регресс-сценарии: `verification-checklist.md`, ADR `local/modules/eklektika.sync/docs/adr/2026-05-02-registration-e2e-verified.md`.
