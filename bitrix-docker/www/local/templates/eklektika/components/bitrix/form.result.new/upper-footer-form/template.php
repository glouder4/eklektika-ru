...
<form enctype="multipart/form-data" id="footer_form-form" method="POST" novalidate="">
    ...
    <div class="field-13">
        <div></div>
            ...
            <div class="field-14"> <input class="obrabotkap1" name="personal_data" type="checkbox" value="Y" required /> Настоящим подтверждаю, что я ознакомлен и согласен с условиями <a href="https://eklektika.ru/oferta/" >политики конфиденциальности</a></div>
    ...
    <div class="field-17">
        <div></div>
            ...
            <div class="field-18"> <input class="obrabotkap1" name="mailing" type="checkbox" value="Y" /> Я даю <a href="https://eklektika.ru/sogl.docx" > согласие </a> на получение email рассылки, рассылки в мессенджерах и sms с новинками, скидками и специальными предложениями </div>
