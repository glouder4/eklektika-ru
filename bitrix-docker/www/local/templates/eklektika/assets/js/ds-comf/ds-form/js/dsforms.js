            ...
            F = function(o, options) {
                ...
                var __result__ = function(data) {
                        ...
                        if (data['error'] == 1) {
                            ...
                            self.form.remove();
                            self.container.find('.scrollform').remove();
                            console.log(2, self.form.attr('id'));
                            if(self.form.attr('id') == "footer_form-form") {
                                var servicesUrl = [
                                    "/nanesenie/",
                                   "/lazernaya-gravirovka/",
                                    "/sublimacionnaya_pechat/",
                                    "/tampopechat/",
                                    "/tisnenie/",
                                    "/polnocvetnaya-uf-pechat/",
                                    "/shelkografiya/",
                                    "/izgotovlenie-shildikov/",
                                    "/markirovka-texnicheskoj-produkczii/",
                                    "/nanesenie-logotipov-na-ezhednevniki/",
                                    "/pechat-na-futbolkax-optom/"
                                ];
                                var searchElement = window.location.pathname;
                                var indexSearchElem = $.inArray(searchElement, servicesUrl);
                                
                                if (document.location.href.indexOf('feedback') !== -1) {
                                    ga('send', 'pageview', '/feedbackok');
                                    ym(1087753, 'reachGoal', 'feedbackok');
                                    console.log('Отправка формы Обратная связь');
                                } else if (document.location.href.indexOf('katalog') !== -1) {
                                    ga('send', 'pageview', '/sendforma');
                                    ym(1087753, 'reachGoal', 'sendforma');
                                    console.log('Отправка формы Обратная связь карточки');
                                } else if (indexSearchElem !== -1) {
                                    ga('send', 'pageview', '/nanesenieok');
                                    ym(1087753, 'reachGoal', 'nanesenieok');
                                    console.log('Отправка формы Обратная связь Услуги');
                                }
                            };
                            if(self.form.attr('id') == "consult_form-form") {
                                    ga('send', 'pageview', '/nanesenieok');
                                    ym(1087753, 'reachGoal', 'nanesenieok');
                                    console.log('Отправка формы страница Нанесение');
                            };
