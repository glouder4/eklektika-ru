...
?>
    ...
    <div itemprop="articleBody">
        <div class="content" style="padding-bottom:0">
            <p>Сублимационная печать производится только на белых клиньях зонтов. Максимальный размер для одного клина 22 х 15 см.</p>
            <p>
                <br>Выбрать товары под сублимацию можно <a href="/catalog/ofis_i_biznes/" rel="nofollow">здесь</a></p>
        </div>
    </div>
