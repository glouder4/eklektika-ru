...
// Обработчик заявок лендинга «День строителя».
// Куда слать лиды:
...
// ========== ФОРМИРУЕМ ПИСЬМО ==========
$subject = 'Заявка: День строителя — ' . $product;
$body = "Лендинг: День строителя 2026\n"
...
function sendLeadToBitrix24($b24_webhook, $data) {
    $fields = [
        'TITLE' => 'День строителя 2026: ' . ($data['product'] ?? ''),
        'NAME' => $data['name'] ?? '',
...
if ($sent || $b24_ok) { http_response_code(200); echo 'OK'; }
